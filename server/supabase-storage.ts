...
export class SupabaseStorage implements IStorage {
  ...
  async createMultipleSystems(insertSystems: InsertSystem[]): Promise<System[]> {
    const systemsData = insertSystems.map((sys) => ({
      ...
      description: sys.description || "INTEL CORE 2 DUO 2.90 GHZ, 4GB RAM, 360GB HDD, LED MONITOR, KB & MOUSE",
  ...
  private mapRowToSystem(row: any): System {
    return {
      ...
      description: row.description || "INTEL CORE 2 DUO 2.90 GHZ, 4GB RAM, 360GB HDD, LED MONITOR, KB & MOUSE",
